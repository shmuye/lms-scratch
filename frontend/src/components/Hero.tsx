...
const Hero = () => {
  return (
    <section
      className="relative -mx-4 sm:-mx-6 -mt-4 sm:-mt-6 min-h-[calc(100vh-4rem)] flex items-center justify-center text-center px-4 sm:px-6 bg-cover bg-center"
      style={{ backgroundImage: `url(${homeImage})` }}
      aria-label="Welcome to ReadSphere"
    >
      <div className="absolute inset-0 bg-gradient-to-br from-slate-900/80 via-primary-950/75 to-slate-900/85" />

      <div className="relative z-10 max-w-3xl py-16 sm:py-20">
        ...
        <h1 className="text-3xl sm:text-5xl md:text-6xl font-bold mb-5 sm:mb-6 leading-tight text-white tracking-tight">
          Make Reading{" "}
          <span className="text-primary-300">Your Habit</span>
        </h1>
